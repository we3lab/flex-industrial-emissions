...
elmas_data = pd.read_csv('../data/load_shapes/Time_series_18_clusters.csv', sep=';', decimal=',', parse_dates=[0], index_col=0)
cluster_names_elmas = json.load(open('../data/load_shapes/cluster_names.json'))
...
# january_df.to_csv('../data/load_shapes/elmas_data_january_24hr_profile.csv')
...
# july_df.to_csv('../data/load_shapes/elmas_data_july_24hr_profile.csv')